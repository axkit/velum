...
// PkColumnValueGenMenthod describes how the value of a primary key column is
// produced when a new row is inserted.
type PkColumnValueGenMenthod string
...
const (
	...
	FriendlySequence PkColumnValueGenMenthod = ""
	...
	CustomSequence PkColumnValueGenMenthod = "customseq"
)
...
// IsolationLevel is the transaction isolation level used in transaction options.
