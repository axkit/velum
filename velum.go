...
// ColumnValueGenMethod describes how the value of a primary key column is
...
const (
	...
	// SerialFieleType means the PK is a SERIAL / BIGSERIAL column; the insert
	// statement uses DEFAULT and lets the database assign the value.
	SerialFieleType ColumnValueGenMethod = "serial"

	// UuidFileType means the PK is a UUID column; the insert statement calls
	...
	// CustomSequece means the PK value is generated by a named sequence whose
